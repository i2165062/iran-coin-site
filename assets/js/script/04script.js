...
const ACC1 = '#e63946';   // red carpet
const ACC2 = '#5eead4';   // turquoise
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  container.innerHTML = "";
  cinemaData.timelineGroups.forEach(group => {
  ...
  function drawMap(c, regions) {
    ...
    // abstract points: Cannes (France/Europe), Venice (Europe), Berlin (Europe), Oscars (USA), Asia festivals
    const pts = {
      Iran:[w*0.50,h*0.60], Europe:[w*0.28,h*0.38],
      USA:[w*0.12,h*0.40], Asia:[w*0.62,h*0.55]
    };
