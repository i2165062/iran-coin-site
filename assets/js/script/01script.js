...
const ACC1 = '#5eead4';   // turquoise green
const ACC2 = '#d4b483';   // golden sandstone
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  container.innerHTML = "";
  architectsData.timelineGroups.forEach(group => {
  ...
  function drawMap(c, regions) {
    ...
    const pts = {
      ...
      Europe: [w * 0.25, h * 0.35], France: [w * 0.22, h * 0.38],
      USA: [w * 0.12, h * 0.40], "Middle East": [w * 0.55, h * 0.55]
    };
