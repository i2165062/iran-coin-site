...
const ACC1 = '#00ffd0';   // turquoise
const ACC2 = '#ffd166';   // gold
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ===== Populate Cards =====
  container.innerHTML = "";
  athletesData.timelineGroups.forEach(group => {
  ...
  function drawMap(c, regions) {
    ...
    const pts = {
      Iran: [w * 0.45, h * 0.55], Asia: [w * 0.55, h * 0.55],
      Europe: [w * 0.25, h * 0.35], USA: [w * 0.12, h * 0.40]
    };
