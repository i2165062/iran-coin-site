...
document.addEventListener("DOMContentLoaded", ()=>{
  ...
  // render eras + cards
  container.innerHTML = "";
  artistsData.timelineGroups.forEach(group=>{
  ...
  // ===== influence bars (safe inside modal) =====
  ...
  function drawMap(c, regions){
    ...
    const pts = {
      ...
      Canada:[w*0.27,h*0.32], Italy:[w*0.50,h*0.33], Japan:[w*0.72,h*0.48],
      "Middle East":[w*0.48,h*0.50]
    };
